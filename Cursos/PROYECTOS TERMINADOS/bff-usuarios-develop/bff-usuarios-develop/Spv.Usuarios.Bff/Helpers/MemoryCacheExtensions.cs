...
namespace Spv.Usuarios.Bff.Helpers
{
    ...
    internal static class MemoryCacheExtensions
    {
        ...
        private static readonly Lazy<Func<MemoryCache, object>> GetEntries6 = new Lazy<Func<MemoryCache, object>>(() =>
        ...
        private static readonly Lazy<Func<object, IDictionary>> GetEntries7 = new Lazy<Func<object, IDictionary>>(() =>
            CreateGetter<object, IDictionary>(
                typeof(MemoryCache).GetNestedType("CoherentState", BindingFlags.NonPublic)!
        ...
        private static readonly Func<MemoryCache, IDictionary> GetEntries =
            Assembly.GetAssembly(typeof(MemoryCache))!.GetName().Version!.Major < 7
                ...
                : (Func<MemoryCache, IDictionary>)(cache => GetEntries7.Value(GetCoherentState.Value(cache)));

        private static ICollection GetKeys(this IMemoryCache memoryCache) => GetEntries((MemoryCache)memoryCache).Keys;
