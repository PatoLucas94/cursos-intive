...
namespace Spv.Usuarios.Bff.Common.Dtos.Client.PersonasClient.Output
{
    ...
    public class EmailExtraInfo : Email
    {
    ...
    public class TelefonoExtraInfo : Telefono
    {
        public UltimaVerificacionPositiva ultima_verificacion_positiva { get; set; }
    }
    ...
    public class ApiPersonaInfoModelOutput
    {
    ...
    public class ApiPersonasFisicaInfoModelOutput
    {
        public int id { get; set; }
        public int pais_documento { get; set; }
        public int tipo_documento { get; set; }
    ...
    public class ApiPersonasFiltroModelOutput
    {
        public int id { get; set; }
        public int pais_documento { get; set; }
        public int tipo_documento { get; set; }
        public string numero_documento { get; set; }
        public List<EmailExtraInfo> emails { get; set; }
        public List<TokenPush> tokens_push { get; set; }
        public List<TelefonoExtraInfo> telefonos { get; set; }
        public List<Domicilio> domicilios { get; set; }
        public List<DocumentoAdicional> documentos_adicionales { get; set; }
        public List<ActividadEconomicaAfip> actividades_economicas_afip { get; set; }
        public List<Impuesto> impuestos { get; set; }
        ...
        public string estado_validacion_documento { get; set; }
        public int? pais_residencia { get; set; }
        public string fecha_enriquecimiento_afip { get; set; }
        public string fecha_enriquecimiento { get; set; }
        public string fecha_creacion { get; set; }
        public string fecha_modificacion { get; set; }
    }
}
