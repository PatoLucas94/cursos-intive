...
{
    public class ObtenerConfiguracionLoginMenssageAsyncTest
    {
        [Fact]
        public void ObtenerConfiguracionLoginMenssageAsyncVacio()
        {
            ...
            // Act
            var resultado = sut.ObtenerConfiguracionLoginMenssageAsync(Headers.ToRequestBody(new LoginMessageModelInput(),
        ...
        [Fact]
        public void ObtenerConfiguracionLoginMenssageAsync()
        {
            // Arrange
