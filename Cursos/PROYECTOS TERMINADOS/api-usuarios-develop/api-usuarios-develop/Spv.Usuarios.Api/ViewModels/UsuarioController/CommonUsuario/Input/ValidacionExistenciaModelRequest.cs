...
namespace Spv.Usuarios.Api.ViewModels.UsuarioController.CommonUsuario.Input
{
    ...
    public class ValidacionExistenciaModelRequest
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IRequestBody<ValidacionExistenciaModelInput> ToRequestBody(ApiHeaders headers, IAllowedChannels allowedChannels)
        {
            return headers?.ToRequestBody(new ValidacionExistenciaModelInput
            {
