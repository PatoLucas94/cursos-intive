...
namespace Spv.Usuarios.Api.ViewModels.ClaveCanalesController.CommonClaveCanales.Input
{
    ...
    public class ValidacionModelRequest
    {
        /// <summary>
        /// Tipo de Documento
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public IRequestBody<ValidacionModelInput> ToRequestBody(ApiHeaders headers, IAllowedChannels allowedChannels)
        {
            return headers?.ToRequestBody(
                new ValidacionModelInput
                {
