...
namespace Spv.Usuarios.Test.Integration.Controllers.v2._0.SsoController
{
    ...
    public class VerificarTokenintegrationTest : ControllerIntegrationTest
    {
        ...
        {
            var uri = new Uri(uriBase, ApiUris.VerificarTokenKeycloakV2);
        ...
        public VerificarTokenintegrationTest(ServerFixture server) : base(server)
        {
            _server = server;
        ...
        [Fact]
        public async Task VerificarToken_SinHeaders_BodyCorrecto_BadRequest()
        {
            // Arrange
            _server.HttpServer.HttpClient.DefaultRequestHeaders.Clear();

            var uri = new Uri(_uriBase, ApiUris.VerificarTokenKeycloakV2 + "?access_token");
        ...
        [Fact]
        public async Task VerificarToken_HeadersIncorrectos_BodyCorrecto_BadRequest()
        {
            // Arrange
        ...
        [Fact]
        public async Task VerificarToken_HeadersIncompletos_BodyCorrecto_BadRequest()
        {
            // Arrange
            var defaultRequestHeaders = _server.HttpServer.HttpClient.DefaultRequestHeaders;
