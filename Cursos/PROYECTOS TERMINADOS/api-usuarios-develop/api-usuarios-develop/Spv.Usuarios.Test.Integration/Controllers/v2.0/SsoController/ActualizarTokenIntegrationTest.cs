...
namespace Spv.Usuarios.Test.Integration.Controllers.v2._0.SsoController
{
    ...
    public class ActualizarTokenIntegrationTest : ControllerIntegrationTest
    {
        ...
        {
            var uri = new Uri(uriBase, ApiUris.ActualizarTokenKeycloakV2);
        ...
        public ActualizarTokenIntegrationTest(ServerFixture server) : base(server)
        {
            _server = server;
        ...
        [Fact]
        public async Task ActualizarToken_SinHeaders_BodyCorrecto_BadRequest()
        {
            // Arrange
            _server.HttpServer.HttpClient.DefaultRequestHeaders.Clear();

            var uri = new Uri(_uriBase, ApiUris.ActualizarTokenKeycloakV2 + "?refresh_token");
        ...
        [Fact]
        public async Task ActualizarToken_HeadersIncorrectos_BodyCorrecto_BadRequest()
        {
            // Arrange
        ...
        [Fact]
        public async Task ActualizarToken_HeadersIncompletos_BodyCorrecto_BadRequest()
        {
            // Arrange
            var defaultRequestHeaders = _server.HttpServer.HttpClient.DefaultRequestHeaders;
